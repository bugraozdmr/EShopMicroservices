...
public class Order : Aggregate<OrderId>
{
    ...
    {
        get => OrderItems.Sum(x => (decimal)x.Price * x.Quantity);
        private set {}
    }
    ...
    {
        // tekrar tekrar kontrole gerek yok zaten digerlerinde yapıldı customerId vs hepsinde
        var order = new Order
        {
            Id = id,
